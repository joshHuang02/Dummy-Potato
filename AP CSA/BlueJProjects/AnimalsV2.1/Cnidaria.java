...
public class Cnidaria extends Animal {
    ...
    //complete version
    public Cnidaria(String name, double currentAgeInYears, boolean isAlive, 
    ...
    public String toString() {
        ...
        for(int i = 0; i < tentacles.length ; i++) {
            if (tentacles[i].getIsWorking()) {
                workingTentacles ++;
            }
        }
        if (mouth.getIsWorking()) {
            return "This is a cnidaria, basically just jellyfishes. It has one mouth and " + tentacles.length + " tentacles, " + workingTentacles + " of which is working. Its mouth is working. ";
        } else {
            return "This is a cnidaria, basically just jellyfishes. It has one mouth and " + tentacles.length + " tentacles, " + workingTentacles + " of which is working. Its mouth is not working. ";
        }
    }
}